...
const faqData = [
  { qEn: 'What services does Ufuq Kifat offer?', qAr: 'ما هي الخدمات التي تقدمها أفق كفات؟', aEn: 'We offer comprehensive engineering services including consulting, infrastructure design, project management, construction supervision, and technical studies.', aAr: 'نقدم خدمات هندسية شاملة تشمل الاستشارات وتصميم البنية التحتية وإدارة المشاريع والإشراف على البناء والدراسات الفنية.' },
